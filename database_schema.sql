...
--
-- Dumping routines for database 'meetupprojectdb'
--
/*!50003 DROP PROCEDURE IF EXISTS `spGetEventsTags` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `spGetEventsTags`(eventid int)
BEGIN
...
/*!50003 DROP PROCEDURE IF EXISTS `spGetGroupsTags` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `spGetGroupsTags`(groupid int)
BEGIN
select tags.id, tags.name from tags
join groups_tags
on groups_tags.tag_id = tags.id
join groups
on groups.id = groups_tags.group_id
where groups_tags.group_id = groupid;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2018-07-26 10:02:19
